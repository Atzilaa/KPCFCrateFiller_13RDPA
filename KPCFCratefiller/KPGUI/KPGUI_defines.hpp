...
#define KP_TEXT_M                       safeZoneH * 0.02  // Taille de texte standard importée de CustomControlClasses.h
...
#define KP_HEIGTH_BUTTON                0.025  // Hauteur standard des boutons importée de CustomControlClasses.h
...
// Couleurs importées de CustomControlClasses.h
#define KP_COLOR_CLOSECROSS             {1, 1, 1, 0.75}
#define KP_COLOR_CLOSECROSS_ACTIVE      {1, 1, 1, 1}
#define KP_COLOR_CLOSECROSS_DISABLED    {1, 1, 1, 0.25}
#define KP_COLOR_BUTTON_BG              {0.2, 0.2, 0.2, 1}
#define KP_COLOR_BUTTON_ACTIVE          {0.3, 0.3, 0.3, 1}
...
// Tailles spécifiques importées de MyDialog.h
#define KP_DIALOG_TITLE_COLOR           {0.9294, 0.8392, 0.0471, 1}
...
#define KP_X_VAL_S                      0.3   // Valeur importée de MyDialog.h
#define KP_Y_VAL_S                      0.05  // Valeur importée de MyDialog.h

#define KP_WIDTH_VAL_S                  0.4   // Valeur importée de MyDialog.h
#define KP_HEIGHT_VAL_S                 (0.75 - KP_HEIGTH_TITLE - KP_HEIGTH_BUTTON - 2 * KP_SPACING_Y)  // Valeur importée de MyDialog.h
