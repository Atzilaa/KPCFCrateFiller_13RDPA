...
class KPGUI_PRE_CloseCross {
    ...
    type = 11;
    style = 48;
    color[] = KP_COLOR_CLOSECROSS;
    colorBackground[] = {0, 0, 0, 0};
    colorText[] = KP_COLOR_CLOSECROSS;
    colorActive[] = KP_COLOR_CLOSECROSS_ACTIVE;
    colorDisabled[] = KP_COLOR_CLOSECROSS_DISABLED;
    soundEnter[] = {"", 0.1, 1};
    soundPush[] = {"", 0.1, 1};
    soundClick[] = {"", 0.1, 1};
    soundEscape[] = {"", 0.1, 1};
...
class KPGUI_PRE_Button {
    ...
    colorBackground[] = KP_COLOR_BUTTON_BG;
    colorBackgroundDisabled[] = {0.2, 0.2, 0.2, 0.5};
    colorBackgroundActive[] = KP_COLOR_BUTTON_ACTIVE;
...
// Inline Button - just like normal buttons but with a static height
class KPGUI_PRE_InlineButton: KPGUI_PRE_Button {
    colorBackground[] = KP_COLOR_BUTTON_BG;
    colorBackgroundActive[] = KP_COLOR_BUTTON_ACTIVE;
    colorFocused[] = KP_COLOR_BUTTON_BG;
    offsetPressedX = safeZoneW * 0.0005;
    offsetPressedY = safeZoneH * 0.001;
};

// Control Button - just like normal buttons but with a static height
class KPGUI_PRE_ControlButton: KPGUI_PRE_Button {
    h = safeZoneH * 0.0225;
};
...
class KPGUI_PRE_ProgressBar
{
    ...
    colorBar[] = {0.9294, 0.8392, 0.0471, 1};
...
class KPGUI_PRE_DialogTitle: KPGUI_PRE_Title {
    x = safeZoneX + safeZoneW * KP_X_VAL;
    y = safeZoneY + safeZoneH * KP_Y_VAL;
    w = safeZoneW * KP_WIDTH_VAL;
};

// Cross symbol
class KPGUI_PRE_DialogCross: KPGUI_PRE_CloseCross {
    x = safeZoneX + safeZoneW * (KP_X_VAL + KP_WIDTH_VAL - 0.02);
...
// Title bar
class KPGUI_PRE_DialogTitleS: KPGUI_PRE_DialogTitle {
    colorBackground[] = KP_DIALOG_TITLE_COLOR;
    x = safeZoneX + safeZoneW * KP_X_VAL_S;
    y = safeZoneY + safeZoneH * KP_Y_VAL_S;
    w = safeZoneW * KP_WIDTH_VAL_S;
};
