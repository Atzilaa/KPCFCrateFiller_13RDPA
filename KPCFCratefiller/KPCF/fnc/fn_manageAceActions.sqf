...
private _action = ["KPCF", localize "STR_KPCF_TITLE", "KPCFCratefiller\KPCF\img\kplogo_ca.paa", {[_this] call KPCF_fnc_openDialog;}, {true}] call ace_interact_menu_fnc_createAction;
